[![Tchelinux 2019 Novo Hamburgo](images/banner.jpg)](#)
...
| **13:30** |  [**Como aprender Python partindo do zero usando apenas recursos online e livros**](#Como_aprender_Python_partindo_do_zero_usando_apenas_recursos_online_e_livros) <br> <span class="label label-success">Principiante</span> <br> Adriano Margarin |  [**Entendendo o Systemd**](#Entendendo_o_Systemd) <br> <span class="label label-warning">Intermediário</span> <br> João Avelino Bellomo Filho | [**Conhecendo os Side Channel Attacks**](#Conhecendo_os_Side_Channel_Attacks) <br> <span class="label label-success">Principiante</span> <br> Tiago Tatim Rodeghiero |
| **14:20** |  [**Porque Você Deve Aprender Rust**](#Porque_Você_Deve_Aprender_Rust) <br> <span class="label label-success">Principiante</span> <br> Julio Biason |  [**DevOps: Passado, presente e futuro**](#DevOps:_Passado,_presente_e_futuro) <br> <span class="label label-success">Principiante</span> <br> Cristiano dos Santos Diedrich |  [**Ferramentas Open Source para Pentest Web**](#Ferramentas_Open_Source_para_Pentest_Web) <br> <span class="label label-success">Principiante</span> <br> Israel Comazzetto dos Reis |
| **15:10** <td colspan=4><center>**Coffee-Break**</center> |
| **15:40** |  [**Nativo, híbrido ou PWA? o que escolher para meu app?**](#Nativo,_híbrido_ou_PWA?_o_que_escolher_para_meu_app?) <br> <span class="label label-success">Principiante</span> <br> Jefferson Cardoso |  [**Multi Stage Build - O milagre da subtração de imagens**](#Multi_Stage_Build_-_O_milagre_da_subtração_de_imagens) <br> <span class="label label-success">Principiante</span> <br> Cristiano dos Santos Diedrich |  [**"Essa câmera faz fotos muito boas, né?"**](#"Essa_câmera_faz_fotos_muito_boas,_né?") <br> <span class="label label-success">Principiante</span> <br> Rafael Guterres Jeffman | 
| **16:30** |  [**Uma Não-Gentil Introdução ao Stream Processing**](#Uma_Não-Gentil_Introdução_ao_Stream_Processing) <br> <span class="label label-warning">Intermediário</span> <br> Julio Biason |  [**Principais motivos pelos quais você precisa ter um backup do seu ambiente**](#Principais_motivos_pelos_quais_você_precisa_ter_um_backup_do_seu_ambiente) <br> <span class="label label-success">Principiante</span> <br> Bruna Grellt |  [**Escrita acadêmica com o Latex**](#Escrita_acadêmica_com_o_Latex) <br> <span class="label label-success">Principiante</span> <br> Patrícia Kayser Vargas Mangan | 
...
### Bruna Grellt 
[Bruna Grellt](https://www.linkedin.com/in/brunagrellt/) é curiosa e comunicativa por natureza, estudante de analise e desenvolvimento de sistemas, adoro desafios, principalmente aqueles que me tiram da zona de conforto e com enorme paixão em ajudar e entender a dor do cliente. Atualmente sou Customer Success na Adentro Cloud Solutions, empresa de Data Center, na qual estou auxiliando o desenvolvimento da Cultura de Sucesso do Cliente em conjunto com a reestruturação de atendimento da equipe de Suporte e Comercial.
...
### Ferramentas Open Source para Pentest Web

Nesta palestra serão vistas as principais falhas de segurança observadas em boa parte dos websites na Internet e as principais ferramentas open source de Pentest usadas na análise de falhas de segurança.

### Israel Comazzetto dos Reis 
[Israel Comazzetto dos Reis](https://www.linkedin.com/in/israel-dos-reis-2a2141166/) é entusiasta de OpenSource, trabalha atualmente como Analista de Suporte Nível 3 e tem interesse na área de Pentest e Segurança. Nas horas vagas é Bug Hunter pelas empresas Hacker One e Bug Crownd. 
